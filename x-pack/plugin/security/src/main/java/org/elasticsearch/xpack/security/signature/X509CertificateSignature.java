...
import org.elasticsearch.xpack.security.support.EncodeToString;
...
public final class X509CertificateSignature implements Writeable {
    ...
    public String encodeToString() throws IOException {
        final String encoded = EncodeToString.encode(this);
    ...
    public static X509CertificateSignature decode(String encoded) throws IOException {
        ...
        try {
            return EncodeToString.decode(encoded, X509CertificateSignature::new);
        } catch (IOException e) {
