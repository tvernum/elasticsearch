...
public class CompositeRolesStore {
    ...
    private void loadRoleDescriptorsAsync(Set<String> roleNames, ActionListener<RolesRetrievalResult> listener) {
        ...
        final List<BiConsumer<Set<String>, ActionListener<RoleRetrievalResult>>> asyncRoleProviders = licenseState
            .isCustomRoleProvidersAllowed() ? allRoleProviders : builtInRoleProviders;
        ...
        new IteratingActionListener<>(
            descriptorsListener,
            (rolesProvider, providerListener) -> {
