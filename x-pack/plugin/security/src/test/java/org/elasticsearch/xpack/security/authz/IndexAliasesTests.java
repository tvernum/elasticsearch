...
public class IndexAliasesTests extends SecurityIntegTestCase {
    ...
    public void testCreateIndexThenAliasesCreateOnlyPermission() {
        ...
        Map<String, String> headers = Collections.singletonMap(
            BASIC_AUTH_HEADER,
            basicAuthHeaderValue("create_only", new SecureString("test123".toCharArray()))
        );
    ...
    public void testCreateIndexAliasesOnlyPermission() {
        assertThrowsAuthorizationException(
            client().filterWithHeader(
                Collections.singletonMap(BASIC_AUTH_HEADER, basicAuthHeaderValue("aliases_only", new SecureString("test123".toCharArray())))
