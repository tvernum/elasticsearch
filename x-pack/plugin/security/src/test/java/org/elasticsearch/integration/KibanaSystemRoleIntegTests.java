...
public class KibanaSystemRoleIntegTests extends SecurityIntegTestCase {
    ...
    public String configUsers() {
        ...
        return super.configUsers() + "kibana_system:" + usersPasswdHashed;
    }

    @Override
    public String configUsersRoles() {
        return super.configUsersRoles() + "kibana_system:kibana_system";
    }
    ...
    public void testCreateIndexDeleteInKibanaIndex() throws Exception {
        ...
        if (randomBoolean()) {
            CreateIndexResponse createIndexResponse = client().filterWithHeader(
                singletonMap("Authorization", UsernamePasswordToken.basicAuthHeaderValue("kibana_system", USERS_PASSWD))
