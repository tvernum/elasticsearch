...
public class CancellableLdapRunnableTests extends ESTestCase {
    ...
    public void testTimingOutARunnable() {
        ...
        final CancellableLdapRunnable runnable = new CancellableLdapRunnable(
    ...
    public void testCallTimeOutAfterRunning() {
        ...
        final CancellableLdapRunnable runnable = new CancellableLdapRunnable(ActionListener.wrap(user -> {
