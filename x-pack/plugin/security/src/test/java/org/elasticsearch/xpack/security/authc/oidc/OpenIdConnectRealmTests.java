...
public class OpenIdConnectRealmTests extends OpenIdConnectTestCase {
    ...
    public void testAuthentication() throws Exception {
        ...
        AuthenticationResult<User> result = authenticateWithOidc(principal, roleMapper, notPopulateMetadata, false, authenticatingRealm, null);
        ...
        if (notPopulateMetadata) {
            assertThat(result.getValue().metadata().size(), equalTo(0));
        } else {
