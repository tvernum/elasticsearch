...
public class LimitedRoleTests extends ESTestCase {
    ...
    public void testAuthorize() {
        ...
        Role fromRole = Role.builder("a-role")
    ...
    public void testCheckClusterAction() {
        Role fromRole = Role.builder("a-role").cluster(Collections.singleton("manage_security"), Collections.emptyList()).build();
        ...
        {
            Role limitedByRole = Role.builder("limited-role").cluster(Collections.singleton("all"), Collections.emptyList()).build();
            assertThat(
        ...
        {
            Role limitedByRole = Role.builder("limited-role").cluster(Collections.singleton("monitor"), Collections.emptyList()).build();
    ...
    public void testCheckClusterPrivilege() {
        ...
        {
            Role limitedByRole = Role.builder("scoped-role").cluster(Collections.singleton("all"), Collections.emptyList()).build();
        ...
        {
            Role limitedByRole = Role.builder("scoped-role").cluster(Collections.singleton("monitor"), Collections.emptyList()).build();
    ...
    public void testGetApplicationPrivilegesByResource() {
        ...
        Role fromRole = Role.builder("test-role")
        ...
        {
            Role limitedByRole = Role.builder("test-role-scoped")
