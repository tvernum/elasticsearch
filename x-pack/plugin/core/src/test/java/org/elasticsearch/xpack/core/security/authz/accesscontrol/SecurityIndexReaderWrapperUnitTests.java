...
public class SecurityIndexReaderWrapperUnitTests extends ESTestCase {
    ...
    public void testDefaultMetaFields() throws Exception {
        securityIndexReaderWrapper = new SecurityIndexReaderWrapper(null, null, threadContext, licenseState, scriptService) {
            @Override
    ...
    public void testFieldPermissionsWithFieldExceptions() throws Exception {
        securityIndexReaderWrapper = new SecurityIndexReaderWrapper(null, null, threadContext, licenseState, null);
