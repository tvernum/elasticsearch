...
public final class KerberosRealmSettings {
     ...
     */
    public static final Setting.AffixSetting<String> HTTP_SERVICE_KEYTAB_PATH = RealmSettings.simpleString(
        TYPE,
        "keytab.path",
        Property.NodeScope
    );
    ...
    public static final Setting.AffixSetting<Boolean> SETTING_KRB_DEBUG_ENABLE = Setting.affixKeySetting(
        ...
        "krb.debug",
        key -> Setting.boolSetting(key, Boolean.FALSE, Property.NodeScope)
    );
    ...
    public static Set<Setting.AffixSetting<?>> getSettings() {
        final Set<Setting.AffixSetting<?>> settings = Sets.newHashSet(
            HTTP_SERVICE_KEYTAB_PATH,
            CACHE_TTL_SETTING,
            CACHE_MAX_USERS_SETTING,
            SETTING_KRB_DEBUG_ENABLE,
