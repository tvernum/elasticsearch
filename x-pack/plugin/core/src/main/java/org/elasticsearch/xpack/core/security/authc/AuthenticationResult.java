...
public final class AuthenticationResult<T> {
    private static final AuthenticationResult<Object> NOT_HANDLED = new AuthenticationResult<>(Status.CONTINUE, null, null, null, null);
    ...
    /**
     * Creates an {@code AuthenticationResult} that indicates that the supplied entity
