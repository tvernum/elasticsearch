...
public class RoleDescriptor implements ToXContentObject, Writeable {
    ...
    public boolean equals(Object o) {
        ...
        if (!name.equals(that.name))
            return false;
        if (!Arrays.equals(clusterPrivileges, that.clusterPrivileges))
            return false;
        if (!Arrays.equals(configurableClusterPrivileges, that.configurableClusterPrivileges))
            return false;
        if (!Arrays.equals(indicesPrivileges, that.indicesPrivileges))
            return false;
        if (!Arrays.equals(applicationPrivileges, that.applicationPrivileges))
            return false;
        if (!metadata.equals(that.getMetadata()))
            return false;
    ...
    public static class IndicesPrivileges implements ToXContentObject, Writeable {
        ...
        public boolean equals(Object o) {
            ...
            if (allowRestrictedIndices != that.allowRestrictedIndices)
                return false;
            if (!Arrays.equals(privileges, that.privileges))
                return false;
            if (!Arrays.equals(grantedFields, that.grantedFields))
                return false;
            if (!Arrays.equals(deniedFields, that.deniedFields))
                return false;
