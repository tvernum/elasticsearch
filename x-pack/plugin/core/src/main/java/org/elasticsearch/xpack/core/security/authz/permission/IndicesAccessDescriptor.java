 ...
 */
public class IndicesAccessDescriptor implements ToXContentObject, Writeable {
    ...
    public IndicesAccessDescriptor(Collection<String> indices, Collection<String> privileges,
    ...
    public IndicesAccessDescriptor(StreamInput in) throws IOException {
        // The use of TreeSet is to provide a consistent order that can be relied upon in tests
    ...
    public boolean equals(Object o) {
        ...
        IndicesAccessDescriptor that = (IndicesAccessDescriptor) o;
