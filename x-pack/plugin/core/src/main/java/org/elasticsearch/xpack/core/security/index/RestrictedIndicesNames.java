...
public final class RestrictedIndicesNames {
    ...
    public static final String INTERNAL_SECURITY_SECRETS_INDEX_7 = ".security-secrets-7";
    public static final String SECURITY_SECRETS_ALIAS = ".security-secrets";
    ...
    // public for tests
    public static final Set<String> RESTRICTED_NAMES = Collections.unmodifiableSet(Sets.newHashSet(
        SECURITY_MAIN_ALIAS, INTERNAL_SECURITY_MAIN_INDEX_6, INTERNAL_SECURITY_MAIN_INDEX_7,
        INTERNAL_SECURITY_TOKENS_INDEX_7, SECURITY_TOKENS_ALIAS,
        INTERNAL_SECURITY_SECRETS_INDEX_7, SECURITY_SECRETS_ALIAS));
