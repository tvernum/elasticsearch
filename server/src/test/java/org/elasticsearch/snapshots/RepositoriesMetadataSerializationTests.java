...
import org.elasticsearch.cluster.metadata.ClusterMetadata.ClusterCustom;
...
public class RepositoriesMetadataSerializationTests extends ChunkedToXContentDiffableSerializationTestCase<ClusterCustom> {

    @Override
    protected ClusterCustom createTestInstance() {
    ...
    @Override
    protected ClusterCustom mutateInstance(ClusterCustom instance) {
    ...
    @Override
    protected ClusterCustom makeTestChanges(ClusterCustom testInstance) {
    ...
    @Override
    protected ClusterCustom doParseInstance(XContentParser parser) throws IOException {
