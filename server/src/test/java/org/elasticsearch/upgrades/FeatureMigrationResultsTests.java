...
public class FeatureMigrationResultsTests extends ChunkedToXContentDiffableSerializationTestCase<ProjectCustom> {
    ...
    @Override
    protected FeatureMigrationResults mutateInstance(ProjectCustom instance) {
