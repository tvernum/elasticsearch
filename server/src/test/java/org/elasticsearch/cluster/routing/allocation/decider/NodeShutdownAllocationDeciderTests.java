...
public class NodeShutdownAllocationDeciderTests extends ESAllocationTestCase {
    ...
    public void testAutoExpandDuringNodeReplacement() {
        ...
        state = ClusterState.builder(state)
            .metadata(Metadata.builder(state.metadata()).putClusterCustom(NodesShutdownMetadata.TYPE, shutdown).build())
            .build();
        assertThatDecision(
            decider.shouldAutoExpandToNode(indexMetadata, DATA_NODE, createRoutingAllocation(state)),
            Decision.Type.YES,
        ...
        return ClusterState.builder(ClusterName.DEFAULT)
            ...
            .metadata(
                Metadata.builder()
                    ...
                    .putClusterCustom(NodesShutdownMetadata.TYPE, createNodesShutdownMetadata(shutdownType, nodeId))
            )
            .build();
    }
