 ...
 */
public class NodesShutdownMetadata implements ClusterMetadata.ClusterCustom {
     ...
     */
    public static class NodeShutdownMetadataDiff implements NamedDiff<ClusterMetadata.ClusterCustom> {
